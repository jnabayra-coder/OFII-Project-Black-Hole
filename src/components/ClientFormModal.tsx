...
export const ClientFormModal: React.FC<ClientFormModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const clientPayload: ClientSummary = {
      ...
      name: name.trim(),
      code: finalCode,
      accountManager: clientToEdit?.accountManager || 'Maria Santos (OFII Key Accounts)',
      industry: clientToEdit?.industry || 'General Logistics & Freight Consignment',
      ...
      primaryContact: primaryContact.trim() || 'Logistics In-Charge',
      email: email.trim() || `contact@${name.toLowerCase().replace(/[^a-z0-9]/g, '') || 'client'}.com.ph`,
      phone: phone.trim() || '+63 (2) 8876-0000',
      address: address.trim() || 'Metro Manila Logistics Hub',
      area,
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white rounded-lg shadow-2xl border border-slate-200 max-w-2xl w-full overflow-hidden my-6">
        ...
        {/* Modal Form */}
        <form onSubmit={handleSubmit} className="p-6 space-y-5 text-xs text-slate-700 bg-slate-50/50 max-h-[75vh] overflow-y-auto">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Intelligent Skin Care Inc. / San Miguel Corp."
                  value={name}
